...
define config.name = _("Огни студенческих ночей")
...
define gui.about = _p("""Девушка по имени Стейси переезжает из Америки в Татарстан,
поступает в местный университет, знакомится с разными студентами. Парни, подруги, вечеринки,
борьба за внимание, приставания парней, сплетни и интриги - все это ждало ее в новом месте.
Но в какой-то день жизнь студентки меняется: она сталкивается с мистикой и загадками. Сможет ли Стейси разгадать их?""")
...
define build.name = "Ognyistudnights"
...
define config.save_directory = "Ognyistudnights-1743671603"
